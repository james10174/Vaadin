      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setClass("com.honeycomb.MyComponent", com.honeycomb.client.MyComponentConnector.class);
            ...
            store.setConstructor(com.honeycomb.client.MyComponentConnector.class, new Invoker() {
              public Object invoke(Object target, Object[] params) {
                return com.google.gwt.core.client.GWT.create(com.honeycomb.client.MyComponentConnector.class);
              }
            });
          ...
          private void load1() {
            ...
            store.setReturnType(com.honeycomb.client.MyComponentConnector.class, "getState", new Type(com.vaadin.shared.AbstractComponentState.class));
          ...
          private void load2() {
            ...
            store.setParamTypes(com.honeycomb.client.MyComponentServerRpc.class, "clicked", new Type[] {new Type(com.vaadin.shared.MouseEventDetails.class), });
            ...
            store.setProxyHandler(com.honeycomb.client.MyComponentServerRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new com.honeycomb.client.MyComponentServerRpc() {
                  public void clicked(com.vaadin.shared.MouseEventDetails p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(com.honeycomb.client.MyComponentServerRpc.class).getMethod("clicked"), new Object [] {p0, });
                  }
                };
              }
            });
          ...
          private void load5() {
            ...
            store.addOnStateChangeMethod(com.honeycomb.client.MyComponentConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.ui.AbstractComponentConnector.class, "handleContextClickListenerChange", new String[] {"registeredEventListeners", }));
